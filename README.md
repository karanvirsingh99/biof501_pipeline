...
The model can be visualized like this: <br>
<img src="images/GWAS%20by%20substraction-02.png" width="300">
...
Here is a visualization of the workflow: <br>
<img src="images/Screen%20Shot%202022-12-09%20at%202.49.58%20PM.png" width="300">
...
| File                                    | Intepretation                                                                                  |
|------------------------------------|------------------------------------|
| results/AN_munge.log                            | Logs how columns in the summary statistics file for AN were interpreted by the munge function  |
| results/BMI_munge.log                           | Logs how columns in the summary statistics file for BMI were interpreted by the munge function |
| results/AN.sumstats.gz_BMI.sumstats.gz_ldsc.log | LDSC summary results for AN and BMI, such as SNP-based heritability and genetic correlation    |
| results/LDSCoutput.RData                        | Covariance matrix that will be used in Step 4                                                  |

*Step 2 - subsetting summary statistics*

| File              | Intepretation                                      |
|-------------------|----------------------------------------------------|
| data/summary_stats/AN_subset_tsv.gz  | AN summary statistics with only chromosome 3 SNPs  |
| data/summary_stats/BMI_subset_tsv.gz | BMI summary statistics with only chromosome 3 SNPs |

*Step 3 - sumstats*

| File                | Intepretation                                                                                                                                                                                  |
|------------------------------------|------------------------------------|
| results/AN_BMI_sumstats.log | Log of sumstats function - useful to check how columns were interpreted, how many SNPs are lost due to MAF, INFO filter, overlap between reference genome, and overlap between the two traits. |
| results/Sumstats.RData      | Harmonized summary statistics with transformed effect sizes, which will be used in Step 4                                                                                                      |

*Step 4 - gwas-by-subtraction model fitting*

| File             | Intepretation                                                                                                                         |
|------------------------------------|------------------------------------|
| results/outputGWAS.RData | List with two entries: the first contains the BMI-dependent effect sizes on AN, and the second the BMI-independent-effect sizes on AN |

*Step 5 - manhattan plot*

| File                          | Intepretation                                                                                                                                                               |
|------------------------------------|------------------------------------|
| results/non_BMI_AN_manhattan_CHR3.pdf | A manhattan plot for chromosome 3, plotting the BMI-independent effect size on AN for all chr3 SNPs. Variants significant at the genome-wide level (p\<5e-8) are annotated, |
